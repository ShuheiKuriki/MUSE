"""
this code is not sure to be excuted correctly
learn initial embeddings using en-map
before run this code, learned mapping should be prepared at --map_path
"""
...
#
# python learn_init_by_en-map.py --langs fr it es de pt random --emb_init norm_mean --emb_norm 4.5 --exp_name fives/en-like --device cuda:0 --map_path dumped/sixes/six_langs_mat --exp_id random_vector --save_univ True
