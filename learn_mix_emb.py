...
#
# python learn_mix_emb.py --langs en_random --langlist en_es_it_fr_de_pt --exp_name six_mix --emb_init norm_mean --emb_norm 5 --emb_lr 1 --dis_sampling 1 --n_epochs 30 --device cuda:1
import os
import time
import json
import argparse
...
from src.utils import bool_flag, initialize_exp, read_txt_embeddings
...
for i, lang in enumerate(langlist):
    emb_path = 'data/wiki.{}.vec'.format(lang)
    dico, _embs = read_txt_embeddings(params, emb_path, lang, False)
    embedding.embs[0].weight.data[i*12500:(i+1)*12500] = _embs[:12500]
