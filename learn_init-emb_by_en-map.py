...
# python learn_emb_w_given_map.py --langs de_pt_random --emb_init uniform_mean --emb_norm 0.01 --exp_name learn_map_w_given_by_en_emb2/de_pt --device cuda:1 --exp_id random_vector --emb_optimizer adam
import os
import time
import json
import argparse
