...
def main():
    ...
    src_words, x = embeddings.read(srcfile, dtype=dtype, max_vocab=200000)
    trg_words, z = embeddings.read(trgfile, dtype=dtype, max_vocab=200000)
    print(f"read embeddings {len(src_words)}, {len(trg_words)}")
