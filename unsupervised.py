...
# data
parser.add_argument("--src_lang", type=str, default='es', help="Source language")
...
parser.add_argument("--gen_optimizer", type=str, default="sgd,lr=0.1", help="Mapping optimizer")
